#this file generates a Decision Tree under gini and entropy and writes the scores into a .csv file
#the trees can be viewed from DTree-Entropy.png and DTree-Gini.png files
...
def decisiontree_500():
    ...
    clf = DecisionTreeClassifier(criterion="gini", max_depth=4, random_state=1, splitter='random')
    clf.compute_importances = True
    clf1 = DecisionTreeClassifier(criterion="entropy", max_depth=4, random_state=1, splitter='random')
    ...
    dataframe_features.to_csv(r'Importance_of_Features_DTree_500.csv')
    ...
    #Gini
    dot_data = StringIO()
    tree.export_graphviz(clf, out_file=dot_data, filled=True, rounded=True, special_characters=True, feature_names=features, class_names=['1', '-1'])
    graph = pydotplus.graph_from_dot_data(dot_data.getvalue())
    graph.write_png('DTree-Gini-500.png')
    Image(graph.create_png())

    # # Entropy
    dot_data1 = StringIO()
    export_graphviz(clf1, out_file=dot_data1, filled=True, rounded=True, special_characters=True,feature_names=features, class_names=['1', '-1'])
    graph = pydotplus.graph_from_dot_data(dot_data1.getvalue())
    graph.write_png('DTree-Entropy-500.png')
    Image(graph.create_png())
    decisiontree_1000()

def decisiontree_1000():
    #pull out pickled svmoutput
    dataframemain = pd.read_pickle('reddit-svmoutput.pkl')
    index_of_features_only = len(dataframemain.columns) - 2
    index_of_svm_binary_output = dataframemain.columns.get_loc("One Class SVM Binary Output")
    ...
    dataframe_features.loc[(dataframe_features['Entropy'] == 0), 'Rank - E'] = ""
    dataframe_features.columns = ['Features', 'Gini', 'Rank - G','Entropy', 'Rank - E']
    dataframe_features.to_csv(r'Importance_of_Features_DTree_1000.csv')
    ...
    graph = pydotplus.graph_from_dot_data(dot_data.getvalue())
    graph.write_png('DTree-Gini-1000.png')
    Image(graph.create_png())
    ...
    export_graphviz(clf1, out_file=dot_data1, filled=True, rounded=True, special_characters=True,feature_names=features, class_names=['1', '-1'])
    graph = pydotplus.graph_from_dot_data(dot_data1.getvalue())
    graph.write_png('DTree-Entropy-1000.png')
    Image(graph.create_png())
    decisiontree_2000()

def decisiontree_2000():
    #pull out pickled svmoutput
    dataframemain = pd.read_pickle('reddit-svmoutput.pkl')
    index_of_features_only = len(dataframemain.columns) - 2
    index_of_svm_binary_output = dataframemain.columns.get_loc("One Class SVM Binary Output")
    ...
    dataframe_features.loc[(dataframe_features['Entropy'] == 0), 'Rank - E'] = ""
    dataframe_features.columns = ['Features', 'Gini', 'Rank - G','Entropy', 'Rank - E']
    dataframe_features.to_csv(r'Importance_of_Features_DTree_2000.csv')
    ...
    export_graphviz(clf, out_file=dot_data, filled=True, rounded=True, special_characters=True,feature_names=features, class_names=['1', '-1'])
    graph = pydotplus.graph_from_dot_data(dot_data.getvalue())
    graph.write_png('DTree-Gini-2000.png')
    Image(graph.create_png())
    ...
    export_graphviz(clf1, out_file=dot_data1, filled=True, rounded=True, special_characters=True,feature_names=features, class_names=['1', '-1'])
    graph = pydotplus.graph_from_dot_data(dot_data1.getvalue())
    graph.write_png('DTree-Entropy-2000.png')
    Image(graph.create_png())
    decisiontree_4000()

def decisiontree_4000():
    #pull out pickled svmoutput
    dataframemain = pd.read_pickle('reddit-svmoutput.pkl')
    index_of_features_only = len(dataframemain.columns) - 2
    index_of_svm_binary_output = dataframemain.columns.get_loc("One Class SVM Binary Output")
    ...
    dataframe_features.loc[(dataframe_features['Entropy'] == 0), 'Rank - E'] = ""
    dataframe_features.columns = ['Features', 'Gini', 'Rank - G','Entropy', 'Rank - E']
    dataframe_features.to_csv(r'Importance_of_Features_DTree_4000.csv')
    ...
    export_graphviz(clf, out_file=dot_data, filled=True, rounded=True, special_characters=True,feature_names=features, class_names=['1', '-1'])
    graph = pydotplus.graph_from_dot_data(dot_data.getvalue())
    graph.write_png('DTree-Gini-4000.png')
    Image(graph.create_png())
    ...
    export_graphviz(clf1, out_file=dot_data1, filled=True, rounded=True, special_characters=True,feature_names=features, class_names=['1', '-1'])
    graph = pydotplus.graph_from_dot_data(dot_data1.getvalue())
    graph.write_png('DTree-Entropy-4000.png')
    Image(graph.create_png())
    decisiontree_6000()

def decisiontree_6000():
    #pull out pickled svmoutput
    dataframemain = pd.read_pickle('reddit-svmoutput.pkl')
    index_of_features_only = len(dataframemain.columns) - 2
    index_of_svm_binary_output = dataframemain.columns.get_loc("One Class SVM Binary Output")
    ...
    dataframe_features.loc[(dataframe_features['Entropy'] == 0), 'Rank - E'] = ""
    dataframe_features.columns = ['Features', 'Gini', 'Rank - G','Entropy', 'Rank - E']
    dataframe_features.to_csv(r'Importance_of_Features_DTree_6000.csv')
    ...
    export_graphviz(clf, out_file=dot_data, filled=True, rounded=True, special_characters=True,feature_names=features, class_names=['1', '-1'])
    graph = pydotplus.graph_from_dot_data(dot_data.getvalue())
    graph.write_png('DTree-Gini-6000.png')
    Image(graph.create_png())
    ...
    export_graphviz(clf1, out_file=dot_data1, filled=True, rounded=True, special_characters=True,feature_names=features, class_names=['1', '-1'])
    graph = pydotplus.graph_from_dot_data(dot_data1.getvalue())
    graph.write_png('DTree-Entropy-6000.png')
    Image(graph.create_png())
    decisiontree_7046()

def decisiontree_7046():
    #pull out pickled svmoutput
    dataframemain = pd.read_pickle('reddit-svmoutput.pkl')
    index_of_features_only = len(dataframemain.columns) - 2
    index_of_svm_binary_output = dataframemain.columns.get_loc("One Class SVM Binary Output")
    ...
    dataframe_features.loc[(dataframe_features['Entropy'] == 0), 'Rank - E'] = ""
    dataframe_features.columns = ['Features', 'Gini', 'Rank - G','Entropy', 'Rank - E']
    dataframe_features.to_csv(r'Importance_of_Features_DTree_7046.csv')
    ...
    export_graphviz(clf, out_file=dot_data, filled=True, rounded=True, special_characters=True,feature_names=features, class_names=['1', '-1'])
    graph = pydotplus.graph_from_dot_data(dot_data.getvalue())
    graph.write_png('DTree-Gini-7046.png')
    Image(graph.create_png())
    ...
    export_graphviz(clf1, out_file=dot_data1, filled=True, rounded=True, special_characters=True,feature_names=features, class_names=['1', '-1'])
    graph = pydotplus.graph_from_dot_data(dot_data1.getvalue())
    graph.write_png('DTree-Entropy-7046.png')
    Image(graph.create_png())

def decisiontree_500():
    #pull out pickled svmoutput
    dataframemain = pd.read_pickle('redditnodes_svmoutput.pkl')
    index_of_features_only = len(dataframemain.columns) - 2
    index_of_svm_binary_output = dataframemain.columns.get_loc("One Class SVM Binary Output")
    ...
    # first 250 and last 250 records = 500 records
    X1 = dataframemain.iloc[:, 5:index_of_features_only]
    X2 = dataframemain.iloc[:, 5:index_of_features_only]
    X3 = X1.append(X2)
    Y1 = dataframemain.iloc[:, index_of_svm_binary_output]
    Y2 = dataframemain.iloc[:, index_of_svm_binary_output]
    Y3 = Y1.append(Y2)
    ...
    dataframe_features.columns = ['Features', 'Gini', 'Rank - G','Entropy', 'Rank - E']
    # dataframe_features = dataframe_features.sort_values(by=["Entropy"], ascending= False) #Sort the dataframe itself
    dataframe_features.to_csv(r'Importance_of_Features_DTree_reddit_nodes.csv')
